...
-- --------------------------------------------------------
/* referenc : https://www.sample-videos.com/download-sample-sql.php(Accessed: 01 ,December ,2022)
-- Table structure for table `user_details`

CREAT TABLE IF NOT EXISTS `user_details` (
...
(10001, 'james812', 'daniel', 'brown', 'Female', '6ce961f58c6f12943531080a444f570d', 1);
#ab